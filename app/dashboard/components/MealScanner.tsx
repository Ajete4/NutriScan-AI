...
export default function MealScanner() {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            setSuccessMessage("Image uploaded successfully. Ready for AI analysis.");
        } catch (err) {
            console.error(err);
    ...
    const handleAnalyze = async () => {
        if (!uploadedImageUrl) {
            setError("Upload the image first.");
            return;
        }
    ...
    const handleSaveMeal = async () => {
        ...
        if (!analysis || !uploadedImageUrl) {
            setError("Analyze the meal first.");
            return;
        }
        ...
        <div className="self-start bg-white border border-slate-200 rounded-[2rem] p-6 shadow-sm space-y-6">
            <div className="flex items-center justify-between gap-4 flex-wrap">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-3 rounded-2xl bg-emerald-600 text-white font-bold hover:bg-emerald-700 transition"
                >
                    <Camera size={18} />
                    Add
                </button>
            ...
            {previewUrl && (
                <div className="space-y-4">
                    ...
                    <div className="flex gap-3 flex-wrap">
                        <button
                            onClick={handleChooseImage}
                            className="px-4 py-3 rounded-2xl border border-slate-200 text-slate-700 font-semibold hover:bg-slate-50 transition"
                        >
                            Change
                        </button>
